@page frontend Документация фронтенда

# Введение

Фронтенд LCTAR — система захвата AR-контента на React, React Three Fiber и связке AprilTag + AlvaAR.
...
- AlvaAR распространяется по лицензии GPLv3.
